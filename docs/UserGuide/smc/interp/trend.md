...
<p style="margin-left: 2em;"><b>order </b> = <code style="text-indent: 0em;">int</code>. <span style="color:#48566B;"> Default 1</span>. </p>
<p style="margin-left: 4em;">Polynomial order.</p>
...
<p style="margin-left: 4em;">Contains data (data), affine transformation (geo_transform) and the estimated covariance (PCOV) of the polynomial coefficients.</p>
<p style="font-size: 120%;color:#9298ED; font-weight: bold;">References:</p>
<p style="text-indent: 2em;">[1] K. Vugrin et al. Confidence region estimation techniques for nonlinear regression in groundwater flow: Three case studies. Water Resources Research, Vol. 43, W03423, doi:10.1029/2005WR004804.</p>
