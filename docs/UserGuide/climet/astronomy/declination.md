...
<p style="font-size: 120%;font-weight: bold;">gma.climet.astronomy.declination</p><span style="background-color:#F4F4F5;display: block;line-height:1.5;border-radius: 0.3rem;"><span style="color: gray;font-size:90%;">[function] </span><span style="color: #616AE5; font-weight: bold;font-size: 125%;">declination</span><span style="font-style: italic; color: black;font-size: 120%;">(day):</span></span>

<p>Calculate declination (red) based on the method recommended by FAO-56.</p>
