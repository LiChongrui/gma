...
<p style="font-size: 120%;font-weight: bold;">gma.math.correction.gamma</p><span style="background-color:#F4F4F5;display: block;line-height:1.5;border-radius: 0.3rem;"><span style="color: gray;font-size:90%;">[function] </span><span style="color: #616AE5; font-weight: bold;font-size: 125%;">gamma</span><span style="font-style: italic; color: black;font-size: 120%;">(data, constant = <span style="color:#48566B">1</span>, ignore_value = <span style="color:#48566B">None</span>, gamma_v = <span style="color:#48566B">1</span>):</span></span>

<p>Gamma transform. Reference equation: Out = constant * ((data - vvmin) / vptp) ** gamma_v) * vptp.</p>
...
<p style="margin-left: 2em;"><b>gamma_v </b> = <code style="text-indent: 0em;">float</code>. <span style="color:#48566B;"> Default 1</span>. </p>
<p style="margin-left: 4em;">Gamma value.</p>
<p style="font-size: 120%;color:#9298ED; font-weight: bold;">**Note:</p>
<p style="margin-left: 2em;"><b>If the input data type is uint8, the data will be transformed between 0 ~ 255.</b></p>
<p style="margin-left: 2em;"><b>Otherwise, it will transform between the maximum and vminimum values of the input array.</b></p>
