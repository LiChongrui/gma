...
<p style="font-size: 120%;font-weight: bold;">gma.math.stretch.std</p><span style="background-color:#F4F4F5;display: block;line-height:1.5;border-radius: 0.3rem;"><span style="color: gray;font-size:90%;">[function] </span><span style="color: #616AE5; font-weight: bold;font-size: 125%;">std</span><span style="font-style: italic; color: black;font-size: 120%;">(data, min_label = <span style="color:#48566B">None</span>, max_label = <span style="color:#48566B">None</span>, ignore_value = <span style="color:#48566B">None</span>, NUMofSTD = <span style="color:#48566B">2</span>):</span></span>

<p>Standard deviation stretch. This method is used to emphasize how much feature values vary from the mean value; it is best when used on normally distributed data.</p>
...
<p style="margin-left: 2em;"><b>NUMofSTD </b> = <code style="text-indent: 0em;">float</code>. <span style="color:#48566B;"> Default 2</span>. </p>
<p style="margin-left: 4em;">Number of standard deviation.</p>
