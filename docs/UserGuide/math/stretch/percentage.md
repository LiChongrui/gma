...
<p style="font-size: 120%;font-weight: bold;">gma.math.stretch.percentage</p><span style="background-color:#F4F4F5;display: block;line-height:1.5;border-radius: 0.3rem;"><span style="color: gray;font-size:90%;">[function] </span><span style="color: #616AE5; font-weight: bold;font-size: 125%;">percentage</span><span style="font-style: italic; color: black;font-size: 120%;">(data, min_label = <span style="color:#48566B">None</span>, max_label = <span style="color:#48566B">None</span>, ignore_value = <span style="color:#48566B">None</span>, min_per = <span style="color:#48566B">5</span>, max_per = <span style="color:#48566B">95</span>):</span></span>

<p>Truncates the array based on the percentage interval entered. Then stretch it to the specified range.</p>
...
<p style="margin-left: 2em;"><b>min_per </b> = <code style="text-indent: 0em;">float</code>. <span style="color:#48566B;"> Default 5</span>. </p>
<p style="margin-left: 4em;">Specify the percentage of the low values to exclude from the stretch, which must be between 0 and 100.</p>
<p style="margin-left: 2em;"><b>max_per </b> = <code style="text-indent: 0em;">float</code>. <span style="color:#48566B;"> Default 5</span>. </p>
<p style="margin-left: 4em;">Specify the percentage of the high values to exclude from the stretch, which must be between 0 and 100.</p>
