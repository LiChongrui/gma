...
sidebar: true
---
<span style="font-size: 120%;font-weight: bold;">gma.crs.ProjMethods.EckertII</span>


<span style="background-color:#EFF0FC;display: block;line-height:1.5"><span style="color: gray;font-size:90%;">class</span> <span style="color: #616AE5; font-weight: bold;font-size: 150%;">EckertII</span><span style="font-style: italic; color: black;font-size: 130%;">(central_meridian = <span style="color:#48566B">0</span>, false_easting = <span style="color:#48566B">0</span>, false_northing = <span style="color:#48566B">0</span>):</span></span>

Eckert II projection method.
